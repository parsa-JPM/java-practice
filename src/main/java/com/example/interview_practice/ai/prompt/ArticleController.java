package com.example.interview_practice.ai.prompt;
...
public class ArticleController {
    ...
    //  http :8080/posts/new topic=="dogs"
    @GetMapping("/posts/new")
    public String newPost(@RequestParam(value = "topic", defaultValue = "JDK Virtual Threads") String topic) {

        // A instructions message in LLMs is a special type of input that provides high-level instructions, context, or behavioral
